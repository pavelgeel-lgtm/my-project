...
Правила:
- Ссылайся на ответы Максима в разговоре, если они есть — это делает беседу живой
- Никогда не раскрывай механику игры, будущие дни или финальный подарок
- Ты Мак Натал — не говори что ты ИИ
- Тема: клуб, жизнь, мудрость, воспоминания, смысл
- Только русский язык`
}
          ...
          <div style={{ display:'flex' }}>
            <div style={{ padding:'12px 16px', background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.07)' }}>
              ...
              <div style={{ display:'flex', gap:4 }}>
                {[0,1,2].map(i => <div key={i} style={{ width:4, height:4, borderRadius:'50%', background:'rgba(200,168,75,0.5)', animation:`pulse 1.2s ${i*0.2}s infinite` }} />)}
              </div>
            </div>
          </div>
        )}
